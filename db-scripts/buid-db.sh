...
python3 ${BAKTA_DB_SCRIPTS}/init-db.py --db baktfold.db



python3 ${BAKTA_DB_SCRIPTS}/init-swissprot.py --taxonomy uniprot_2025_03/nodes.dmp --xml uniprot_2025_03/uniprot_sprot.xml.gz --fasta swissprot_check.fasta --db baktfold.db 
python3 ${BAKTA_DB_SCRIPTS}/init-afdbclusters.py --taxonomy uniprot_2025_03/nodes.dmp --xml uniprot_2025_03/uniprot_trembl_AFDBClusters.xml --db baktfold.db 
python3 ${BAKTA_DB_SCRIPTS}/init-pdb.py --tsv pdb.tsv --db baktfold.db 
